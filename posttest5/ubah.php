            ...
            <form action="" method="post">
                <table border="0" width="80%">
                    ...
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <td> <br> :</td>
                        <td> <br> <input type="text" maxlength="100" name="nama" size="50" placeholder="Nama Lengkap" required="" value = "<?php echo $mhs['Nama']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="email">Email</label></td>
                        <td> <br> : </td>
                        <td> <br> <input type="email" name="email" placeholder="Alamat Email" required="" value = "<?php echo $mhs['Email']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="ukuran">Ukuran Sepatu</label></td>
                        <td> <br> : </td>
                        <td> <br> <input type="number" name="ukuran" min="30" max="50" value="<?php echo $mhs['Ukuran']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="barang">Barang</label></td>
                        <td> <br> :</td>
                        <td> <br> <select name="barang" required="" value="<?php echo $mhs['Barang']; ?>">
                            <option></option>
                    ...
                    <tr>
                        ...
                        <td> <br> : </td>
                        <td> <br> <input type="number" name="jumlah" min="1" value = "<?php echo $mhs['Jumlah']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="alamat">Alamat</label></td>
                        <td> <br> :</td>
                        <td> <br> <textarea name="alamat" placeholder="Alamat Penerima" required="" value = "<?php echo $mhs['Alamat']; ?>"></textarea></td>
                    </tr>
                    <tr>
