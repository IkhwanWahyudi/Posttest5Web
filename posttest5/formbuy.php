    ...
    <body>
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td> <a href="ubah.php?Nomor=<?php echo $psn['Nomor']; ?>">Edit</a> | <a href="hapus.php?Nomor=<?php echo $psn['Nomor']; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" >Hapus</a> </td>
            </tr>
            <?php $i++; endforeach ?>
        </table>
